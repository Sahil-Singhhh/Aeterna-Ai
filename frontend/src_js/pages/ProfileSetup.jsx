      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              <label className="block text-xs uppercase font-mono text-text-muted mb-2">
                Age
              </label>
              <input
                type="number"
          ...
          <div>
            ...
            >
              ...
              <option value="Very Active">
                Very Active (Hard physical job)
              </option>
            </select>
          </div>

          <div>
            <label className="block text-xs uppercase font-mono text-text-muted mb-3">
              Prior Medical Conditions
            </label>
            <div className="flex flex-wrap gap-3">
              {["None", "Diabetes", "Thyroid", "Hypertension"].map((cond) => {
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setProfile((p) => ({ ...p, medications: e.target.value }))
              }
